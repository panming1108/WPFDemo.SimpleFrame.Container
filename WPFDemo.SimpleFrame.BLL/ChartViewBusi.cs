...
namespace WPFDemo.SimpleFrame.BLL
{
    ...
    {
        public Task<Dictionary<DateTime, double>> GetBigAverageDatas()
        {
            return GenerateBigData();
        }

        public Task<Dictionary<DateTime, double>> GetBigChartDatas()
        {
            return GenerateBigData();
        }

        public Task<Dictionary<DateTime, double>> GetFixAverageDatas()
        {
        ...
        public Task<Dictionary<DateTime, double>> GetFixChartDatas()
        {
            return Task.Factory.StartNew(
                ()=> 
                {
        ...
        public Task<Dictionary<DateTime, double>> GetSmallAverageDatas()
        {
            return GenerateSmallData();
        }

        public Task<Dictionary<DateTime, double>> GetSmallChartDatas()
        {
            return GenerateSmallData();
        }

        private Task<Dictionary<DateTime, double>> GenerateSmallData()
        {
            return Task.Factory.StartNew(
                ()=> 
                {
        ...
        private Task<Dictionary<DateTime, double>> GenerateBigData()
        {
            return Task.Factory.StartNew(
                ()=> 
                {
